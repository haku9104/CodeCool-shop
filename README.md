...
- From the project folder run the "mvn jetty:run" command to start the project.

- Login via: username = "name", password = "password".

- E-mail sender is implemented but requires an API key, so in the code it is commented for now.

##### BELOW ARE THE ORIGINAL README POINTS #####
